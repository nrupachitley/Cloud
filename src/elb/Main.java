...
public class Main {
    ...
    static {
        ...
        instances[0] = new DataCenterInstance("first_instance", "http://ec2-52-91-225-229.compute-1.amazonaws.com");
        instances[1] = new DataCenterInstance("second_instance", "http://ec2-52-91-197-37.compute-1.amazonaws.com");
        instances[2] = new DataCenterInstance("third_instance", "http://ec2-52-91-215-126.compute-1.amazonaws.com");
    }
